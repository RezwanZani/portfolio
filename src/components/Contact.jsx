      ...
      <div className="container mx-auto max-w-[1400px] xl:max-w-[1200px] 2xl:max-w-[1280px] relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-12 max-w-6xl mx-auto">
          ...
          <div className="lg:w-1/3 space-y-8">
            ...
            {/* Status Card */}
            <div className="p-6 bg-white dark:bg-gray-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
            ...
            <div className="flex gap-4">
              <a href="https://github.com/RezwanZani" className="p-3 bg-slate-200 dark:bg-gray-800 rounded-lg hover:bg-cyan-600 hover:text-white dark:hover:bg-cyan-500 dark:hover:text-slate-900 transition-all">
                <Github className="w-5 h-5" />
              </a>
              <a href="https://www.linkedin.com/in/rezwanzani" className="p-3 bg-slate-200 dark:bg-gray-800 rounded-lg hover:bg-cyan-600 hover:text-white dark:hover:bg-cyan-500 dark:hover:text-slate-900 transition-all">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="https://www.facebook.com/rezwans19" className="p-3 bg-slate-200 dark:bg-gray-800 rounded-lg hover:bg-cyan-600 hover:text-white dark:hover:bg-cyan-500 dark:hover:text-slate-900 transition-all">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/rezwan.shajib" className="p-3 bg-slate-200 dark:bg-gray-800 rounded-lg hover:bg-cyan-600 hover:text-white dark:hover:bg-cyan-500 dark:hover:text-slate-900 transition-all">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="https://wa.me/8801315201696" className="p-3 bg-slate-200 dark:bg-gray-800 rounded-lg hover:bg-cyan-600 hover:text-white dark:hover:bg-cyan-500 dark:hover:text-slate-900 transition-all">
